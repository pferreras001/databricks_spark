...
description = "Vulk INSERT into IoT devices table using Trasact-sql querys"
...
for i in range(20):
    spark.sql(
        f"""
            INSERT INTO devices_insert_bronze (device_id, device_type, ip, cca3, cn, temp, signal, battery_level, c02_level,timestamp)
            VALUES (99999, 'sensor_ipdad', '68.161.225.145', 'EUS', 'Euskal Herria', 22, 22, 8, 917, NOW())
        """
    )
